                        ...
                        <ul className='flex items-center'>
                            ...
                            <Link to={"/About"}>
                                <span className='text-green-600 text-l font-bold
                                 px-0 py-4 mr-52'>Dượt Sĩ thầu dầu</span>
                                <p>Email: duocsithaudau@gmail.com</p>
                            </Link>
                            <Link to={"/About"}>
                                <span className='px-6 py-4'>Giới thiệu về chúng tôi</span>
                            </Link>
                            <Link to={"/"}>
                                <span className='px-6 py-4'>Chính sách bảo mật người dùng</span>
                            </Link>
                            <Link to={"/vocational-guidance"}>
                                <span className='px-6 py-4'>Hướng nghiệp</span>
                            </Link>
                            <Link to={"/Event"}>
                                <span className='px-6 py-4'>Sự kiện</span>
                            </Link>

                        </ul>
                    </div>
                    <div class="flex justify-center">
                        <Link to={"/Facebook"} class="mr-6 text-gray-600">
                            <i class="fa-brands fa-facebook"></i>
                        </Link>
                        <Link to={"/Instagram"} class="mr-6 text-gray-600">
                            <i class="fa-brands fa-instagram"></i>
                        </Link>
                        <Link to={"/Youtube"} class="mr-6 text-gray-600">
